...
export default function Home() {
  return (
    ...
    <div className=" bg-[#1D1B31] h-[670px] rounded-bl-[150px] grid justify-center ">
      <div>
      ...
      <div className=" max-sm:mx-[12px] ">
       <h2 className=" font-extrabold text-[40px] text-white text-center mt-[69px] max-sm:text-[25px]">Devenez un leader de l'éducation <br/> environnementale et du développement durable</h2>
       </div>
       <p className=" text-white text-[22px] font-light text-center max-sm:text-[17px] m max-sm:mx-20 ">Cpefed , votre partenaire vers un métier indispensable, nos alumni vous en parlent.</p>
       <div className="bg-[url('../public/Group _5540.svg')]" ></div>
        <div>
       <div className=" w-[992.93px] h-[433px] bg-[#1AD079] mt-16 rounded-[50px] grid grid-cols-2 gap-20">
         <div className=" col-span-1 bg-black w-[574.26px] h-[414.57px] m-2.5 rounded-[40px] ">
          <Image src="/hijabi2.png" width={574.26} height={414.57} className="rounded-[40px]"/>
         </div>
         <div className="col-span-1 mx-24 mt-8  w-[321.42px]">
            <div >
              <h1 className="text-white font-extrabold text-[25px]">Rejoignez Cpefed</h1>
            </div>
            <div className="mt-[20px] ">
              <form>
                <div>
                  <input type="text" placeholder="Nom*" className=" btn"/>
                  <input type="text" placeholder="Prénom" className=" btn"/>
                  <input type="email" placeholder="Email*" className=" btn"/>
                  <input type="tel" placeholder="01 02 03 04 05*" className=" btn"/>
                </div>
               <div className=" bg-white w-[203.7px] h-[45.04px] rounded-xl flex float-end mt-3">
